...
* Build full-featured web apps with Django + DRF and Go + Gin
* Database design and optimisation (Postgres, MongoDB)
* Automated testing, CI/CD, and containerised deployments (Docker)
* Write clear technical documentation and developer-focused blog posts
...
* 🧾 Hashnode: [https://thecodingprocess.hashnode.dev/](https://thecodingprocess.hashnode.dev/)

I’m open to backend roles, contract work, and collaborations on meaningful projects. Feel free to reach out!
